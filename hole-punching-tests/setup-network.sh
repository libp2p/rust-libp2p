...
ip netns exec internet_ns ip addr add 10.0.0.1 dev relay_pub_veth
ip netns exec relay_ns ip addr add 192.168.254.1/24 dev relay_veth

ip netns exec internet_ns ip addr add 10.0.0.2 dev listen_pub_veth
ip netns exec listener_ns ip addr add 192.168.1.1/24 dev listener_veth

ip netns exec internet_ns ip addr add 10.0.0.3 dev dialer_pub_veth
