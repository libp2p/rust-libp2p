...
pub struct Config {
    ...
    /// Maximum message size in bytes (default: 65536 = 64KB).
    max_message_size: usize,
    /// Timeout for substream upgrades (default: 30 seconds).
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            substream_timeout: Duration::from_secs(30), // 30 seconds default
        }
    }
}
