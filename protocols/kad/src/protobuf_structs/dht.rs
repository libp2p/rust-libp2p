...
impl ::protobuf::Message for Message {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.key_prefix.is_empty() {
            my_size += ::protobuf::rt::bytes_size(222, &self.key_prefix);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.key_prefix.is_empty() {
            os.write_bytes(222, &self.key_prefix)?;
        }
        if let Some(ref v) = self.record.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "key_prefix",
                    |m: &Message| { &m.key_prefix },
                    |m: &mut Message| { &mut m.key_prefix },
                ));
...
impl ::protobuf::Message for Message_Peer {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.key_prefix.is_empty() {
            my_size += ::protobuf::rt::bytes_size(444, &self.key_prefix);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.key_prefix.is_empty() {
            os.write_bytes(444, &self.key_prefix)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "key_prefix",
                    |m: &Message_Peer| { &m.key_prefix },
                    |m: &mut Message_Peer| { &mut m.key_prefix },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x89\x06\x20\x01(\rR\x03ttl\"\x85\x05\n\x07Message\x12/\n\x04type\x18\
    \x01\x20\x01(\x0e2\x1b.dht.pb.Message.MessageTypeR\x04type\x12(\n\x0fclu\
    sterLevelRaw\x18\n\x20\x01(\x05R\x0fclusterLevelRaw\x12\x10\n\x03key\x18\
    \x02\x20\x01(\x0cR\x03key\x12\x1e\n\nkey_prefix\x18\xde\x01\x20\x01(\x0c\
    R\tkeyPrefix\x12&\n\x06record\x18\x03\x20\x01(\x0b2\x0e.dht.pb.RecordR\
    \x06record\x126\n\x0bcloserPeers\x18\x08\x20\x03(\x0b2\x14.dht.pb.Messag\
    e.PeerR\x0bcloserPeers\x12:\n\rproviderPeers\x18\t\x20\x03(\x0b2\x14.dht\
    .pb.Message.PeerR\rproviderPeers\x1a\x8c\x01\n\x04Peer\x12\x0e\n\x02id\
    \x18\x01\x20\x01(\x0cR\x02id\x12\x14\n\x05addrs\x18\x02\x20\x03(\x0cR\
    \x05addrs\x12>\n\nconnection\x18\x03\x20\x01(\x0e2\x1e.dht.pb.Message.Co\
    nnectionTypeR\nconnection\x12\x1e\n\nkey_prefix\x18\xbc\x03\x20\x01(\x0c\
    R\tkeyPrefix\"i\n\x0bMessageType\x12\r\n\tPUT_VALUE\x10\0\x12\r\n\tGET_V\
    ALUE\x10\x01\x12\x10\n\x0cADD_PROVIDER\x10\x02\x12\x11\n\rGET_PROVIDERS\
    \x10\x03\x12\r\n\tFIND_NODE\x10\x04\x12\x08\n\x04PING\x10\x05\"W\n\x0eCo\
    nnectionType\x12\x11\n\rNOT_CONNECTED\x10\0\x12\r\n\tCONNECTED\x10\x01\
    \x12\x0f\n\x0bCAN_CONNECT\x10\x02\x12\x12\n\x0eCANNOT_CONNECT\x10\x03J\
    \xc2\x1a\n\x06\x12\x04\0\0_\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\
    \x01\x02\x12\x03\x01\x08\x0e\nX\n\x02\x04\0\x12\x04\x05\0\x1c\x01\x1aL\
    \x20Record\x20represents\x20a\x20dht\x20record\x20that\x20contains\x20a\
    \x20value\n\x20for\x20a\x20key\x20value\x20pair\n\n\n\n\x03\x04\0\x01\
    \x12\x03\x05\x08\x0e\n2\n\x04\x04\0\x02\0\x12\x03\x07\x08\x16\x1a%\x20Th\
    e\x20key\x20that\x20references\x20this\x20record\n\n\r\n\x05\x04\0\x02\0\
    \x04\x12\x04\x07\x08\x05\x10\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x07\x08\
    \r\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x07\x0e\x11\n\x0c\n\x05\x04\0\x02\
    \0\x03\x12\x03\x07\x14\x15\n6\n\x04\x04\0\x02\x01\x12\x03\n\x08\x18\x1a)\
    \x20The\x20actual\x20value\x20this\x20record\x20is\x20storing\n\n\r\n\
    \x05\x04\0\x02\x01\x04\x12\x04\n\x08\x07\x16\n\x0c\n\x05\x04\0\x02\x01\
    \x05\x12\x03\n\x08\r\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\n\x0e\x13\n\
    \x0c\n\x05\x04\0\x02\x01\x03\x12\x03\n\x16\x17\n\xfc\x01\n\x04\x04\0\x02\
    \x02\x12\x03\x13\x08\x20\x1a/\x20Time\x20the\x20record\x20was\x20receive\
    d,\x20set\x20by\x20receiver\n2\xbd\x01\x20Note:\x20These\x20fields\x20we\
    re\x20removed\x20from\x20the\x20Record\x20message\n\x20hash\x20of\x20the\
    \x20authors\x20public\x20key\noptional\x20string\x20author\x20=\x203;\n\
    \x20A\x20PKI\x20signature\x20for\x20the\x20key+value+author\noptional\
    \x20bytes\x20signature\x20=\x204;\n\n\r\n\x05\x04\0\x02\x02\x04\x12\x04\
    \x13\x08\n\x18\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03\x13\x08\x0e\n\x0c\n\
    \x05\x04\0\x02\x02\x01\x12\x03\x13\x0f\x1b\n\x0c\n\x05\x04\0\x02\x02\x03\
    \x12\x03\x13\x1e\x1f\nX\n\x04\x04\0\x02\x03\x12\x03\x17\x04\x1a\x1aK\x20\
    The\x20original\x20publisher\x20of\x20the\x20record.\n\x20Currently\x20s\
    pecific\x20to\x20rust-libp2p.\n\n\r\n\x05\x04\0\x02\x03\x04\x12\x04\x17\
    \x04\x13\x20\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03\x17\x04\t\n\x0c\n\x05\
    \x04\0\x02\x03\x01\x12\x03\x17\n\x13\n\x0c\n\x05\x04\0\x02\x03\x03\x12\
    \x03\x17\x16\x19\n_\n\x04\x04\0\x02\x04\x12\x03\x1b\x04\x15\x1aR\x20The\
    \x20remaining\x20TTL\x20of\x20the\x20record,\x20in\x20seconds.\n\x20Curr\
    ently\x20specific\x20to\x20rust-libp2p.\n\n\r\n\x05\x04\0\x02\x04\x04\
    \x12\x04\x1b\x04\x17\x1a\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03\x1b\x04\n\
    \n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03\x1b\x0b\x0e\n\x0c\n\x05\x04\0\x02\
    \x04\x03\x12\x03\x1b\x11\x14\n\n\n\x02\x04\x01\x12\x04\x1e\0_\x01\n\n\n\
    \x03\x04\x01\x01\x12\x03\x1e\x08\x0f\n\x0c\n\x04\x04\x01\x04\0\x12\x04\
    \x1f\x08&\t\n\x0c\n\x05\x04\x01\x04\0\x01\x12\x03\x1f\r\x18\n\r\n\x06\
    \x04\x01\x04\0\x02\0\x12\x03\x20\x10\x1e\n\x0e\n\x07\x04\x01\x04\0\x02\0\
    \x01\x12\x03\x20\x10\x19\n\x0e\n\x07\x04\x01\x04\0\x02\0\x02\x12\x03\x20\
    \x1c\x1d\n\r\n\x06\x04\x01\x04\0\x02\x01\x12\x03!\x10\x1e\n\x0e\n\x07\
    \x04\x01\x04\0\x02\x01\x01\x12\x03!\x10\x19\n\x0e\n\x07\x04\x01\x04\0\
    \x02\x01\x02\x12\x03!\x1c\x1d\n\r\n\x06\x04\x01\x04\0\x02\x02\x12\x03\"\
    ...
    \x04\x01\x04\0\x02\x04\x12\x03$\x10\x1e\n\x0e\n\x07\x04\x01\x04\0\x02\
    \x04\x01\x12\x03$\x10\x19\n\x0e\n\x07\x04\x01\x04\0\x02\x04\x02\x12\x03$\
    \x1c\x1d\n\r\n\x06\x04\x01\x04\0\x02\x05\x12\x03%\x10\x19\n\x0e\n\x07\
    \x04\x01\x04\0\x02\x05\x01\x12\x03%\x10\x14\n\x0e\n\x07\x04\x01\x04\0\
    \x02\x05\x02\x12\x03%\x17\x18\n\x0c\n\x04\x04\x01\x04\x01\x12\x04(\x085\
    \t\n\x0c\n\x05\x04\x01\x04\x01\x01\x12\x03(\r\x1b\n^\n\x06\x04\x01\x04\
    \x01\x02\0\x12\x03*\x10\"\x1aO\x20sender\x20does\x20not\x20have\x20a\x20\
    connection\x20to\x20peer,\x20and\x20no\x20extra\x20information\x20(defau\
    lt)\n\n\x0e\n\x07\x04\x01\x04\x01\x02\0\x01\x12\x03*\x10\x1d\n\x0e\n\x07\
    \x04\x01\x04\x01\x02\0\x02\x12\x03*\x20!\n5\n\x06\x04\x01\x04\x01\x02\
    \x01\x12\x03-\x10\x1e\x1a&\x20sender\x20has\x20a\x20live\x20connection\
    \x20to\x20peer\n\n\x0e\n\x07\x04\x01\x04\x01\x02\x01\x01\x12\x03-\x10\
    \x19\n\x0e\n\x07\x04\x01\x04\x01\x02\x01\x02\x12\x03-\x1c\x1d\n2\n\x06\
    \x04\x01\x04\x01\x02\x02\x12\x030\x10\x20\x1a#\x20sender\x20recently\x20\
    connected\x20to\x20peer\n\n\x0e\n\x07\x04\x01\x04\x01\x02\x02\x01\x12\
    \x030\x10\x1b\n\x0e\n\x07\x04\x01\x04\x01\x02\x02\x02\x12\x030\x1e\x1f\n\
    \xa7\x01\n\x06\x04\x01\x04\x01\x02\x03\x12\x034\x10#\x1a\x97\x01\x20send\
    ...
    \x04\x01\x03\0\x02\0\x12\x039\x10\x1d\x1a\x15\x20ID\x20of\x20a\x20given\
    \x20peer.\n\n\x0f\n\x07\x04\x01\x03\0\x02\0\x04\x12\x049\x107\x16\n\x0e\
    \n\x07\x04\x01\x03\0\x02\0\x05\x12\x039\x10\x15\n\x0e\n\x07\x04\x01\x03\
    \0\x02\0\x01\x12\x039\x16\x18\n\x0e\n\x07\x04\x01\x03\0\x02\0\x03\x12\
    \x039\x1b\x1c\n,\n\x06\x04\x01\x03\0\x02\x01\x12\x03<\x10)\x1a\x1d\x20mu\
    ltiaddrs\x20for\x20a\x20given\x20peer\n\n\x0e\n\x07\x04\x01\x03\0\x02\
    \x01\x04\x12\x03<\x10\x18\n\x0e\n\x07\x04\x01\x03\0\x02\x01\x05\x12\x03<\
    \x19\x1e\n\x0e\n\x07\x04\x01\x03\0\x02\x01\x01\x12\x03<\x1f$\n\x0e\n\x07\
    \x04\x01\x03\0\x02\x01\x03\x12\x03<'(\nP\n\x06\x04\x01\x03\0\x02\x02\x12\
    \x03?\x10.\x1aA\x20used\x20to\x20signal\x20the\x20sender's\x20connection\
    \x20capabilities\x20to\x20the\x20peer\n\n\x0f\n\x07\x04\x01\x03\0\x02\
    \x02\x04\x12\x04?\x10<)\n\x0e\n\x07\x04\x01\x03\0\x02\x02\x06\x12\x03?\
    \x10\x1e\n\x0e\n\x07\x04\x01\x03\0\x02\x02\x01\x12\x03?\x1f)\n\x0e\n\x07\
    \x04\x01\x03\0\x02\x02\x03\x12\x03?,-\n\x15\n\x06\x04\x01\x03\0\x02\x03\
    \x12\x03B\x10'\x1a\x06\x20TODO\n\n\x0f\n\x07\x04\x01\x03\0\x02\x03\x04\
    \x12\x04B\x10?.\n\x0e\n\x07\x04\x01\x03\0\x02\x03\x05\x12\x03B\x10\x15\n\
    \x0e\n\x07\x04\x01\x03\0\x02\x03\x01\x12\x03B\x16\x20\n\x0e\n\x07\x04\
    \x01\x03\0\x02\x03\x03\x12\x03B#&\n2\n\x04\x04\x01\x02\0\x12\x03F\x08\
    \x1d\x1a%\x20defines\x20what\x20type\x20of\x20message\x20it\x20is.\n\n\r\
    \n\x05\x04\x01\x02\0\x04\x12\x04F\x08C\t\n\x0c\n\x05\x04\x01\x02\0\x06\
    \x12\x03F\x08\x13\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03F\x14\x18\n\x0c\n\
    \x05\x04\x01\x02\0\x03\x12\x03F\x1b\x1c\n\x9f\x01\n\x04\x04\x01\x02\x01\
    \x12\x03J\x08#\x1a\x85\x01\x20defines\x20what\x20coral\x20cluster\x20lev\
    el\x20this\x20query/response\x20belongs\x20to.\n\x20in\x20case\x20we\x20\
    want\x20to\x20implement\x20coral's\x20cluster\x20rings\x20in\x20the\x20f\
    uture.\n\"\n\x20NOT\x20USED\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04J\x08\
    F\x1d\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03J\x08\r\n\x0c\n\x05\x04\x01\
    \x02\x01\x01\x12\x03J\x0e\x1d\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03J\
    \x20\"\n\x88\x01\n\x04\x04\x01\x02\x02\x12\x03N\x08\x16\x1a{\x20Used\x20\
    to\x20specify\x20the\x20(raw)\x20key\x20associated\x20with\x20this\x20me\
    ssage.\n\x20FIND_NODE,\x20PUT_VALUE,\x20GET_VALUE,\x20ADD_PROVIDER,\x20G\
    ET_PROVIDERS\n\n\r\n\x05\x04\x01\x02\x02\x04\x12\x04N\x08J#\n\x0c\n\x05\
    \x04\x01\x02\x02\x05\x12\x03N\x08\r\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\
    \x03N\x0e\x11\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03N\x14\x15\n_\n\x04\
    \x04\x01\x02\x03\x12\x03R\x08\x1f\x1aR\x20Used\x20to\x20specify\x20the\
    \x20static\x20DHT\x20key\x20prefix\x20to\x20associate\x20with\x20the\n\
    \x20(hashed)\x20`key`.\n\n\r\n\x05\x04\x01\x02\x03\x04\x12\x04R\x08N\x16\
    \n\x0c\n\x05\x04\x01\x02\x03\x05\x12\x03R\x08\r\n\x0c\n\x05\x04\x01\x02\
    \x03\x01\x12\x03R\x0e\x18\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03R\x1b\
    \x1e\n;\n\x04\x04\x01\x02\x04\x12\x03V\x08\x1a\x1a.\x20Used\x20to\x20ret\
    urn\x20a\x20value\n\x20PUT_VALUE,\x20GET_VALUE\n\n\r\n\x05\x04\x01\x02\
    \x04\x04\x12\x04V\x08R\x1f\n\x0c\n\x05\x04\x01\x02\x04\x06\x12\x03V\x08\
    \x0e\n\x0c\n\x05\x04\x01\x02\x04\x01\x12\x03V\x0f\x15\n\x0c\n\x05\x04\
    \x01\x02\x04\x03\x12\x03V\x18\x19\nc\n\x04\x04\x01\x02\x05\x12\x03Z\x08&\
    \x1aV\x20Used\x20to\x20return\x20peers\x20closer\x20to\x20a\x20key\x20in\
    \x20a\x20query\n\x20GET_VALUE,\x20GET_PROVIDERS,\x20FIND_NODE\n\n\x0c\n\
    \x05\x04\x01\x02\x05\x04\x12\x03Z\x08\x10\n\x0c\n\x05\x04\x01\x02\x05\
    \x06\x12\x03Z\x11\x15\n\x0c\n\x05\x04\x01\x02\x05\x01\x12\x03Z\x16!\n\
    \x0c\n\x05\x04\x01\x02\x05\x03\x12\x03Z$%\nO\n\x04\x04\x01\x02\x06\x12\
    \x03^\x08(\x1aB\x20Used\x20to\x20return\x20Providers\n\x20GET_VALUE,\x20\
    ADD_PROVIDER,\x20GET_PROVIDERS\n\n\x0c\n\x05\x04\x01\x02\x06\x04\x12\x03\
    ^\x08\x10\n\x0c\n\x05\x04\x01\x02\x06\x06\x12\x03^\x11\x15\n\x0c\n\x05\
    \x04\x01\x02\x06\x01\x12\x03^\x16#\n\x0c\n\x05\x04\x01\x02\x06\x03\x12\
    \x03^&'b\x06proto3\
";
