...
impl ToString for ProtocolId {
    fn to_string(&self) -> String {
        match *self {
            ...
            ProtocolId::DNS4 => "dns4".to_owned(),
            ProtocolId::DNS6 => "dns6".to_owned(),
            ProtocolId::SCTP => "sctp".to_owned(),
            ProtocolId::UDT => "udt".to_owned(),
            ProtocolId::UTP => "utp".to_owned(),
            ProtocolId::UNIX => "unix".to_owned(),
            ...
            ProtocolId::QUIC => "quic".to_owned(),
            ProtocolId::WS => "ws".to_owned(),
            ProtocolId::WSS => "wss".to_owned(),
            ProtocolId::Libp2pWebsocketStar => "p2p-websocket-star".to_owned(),
            ProtocolId::Libp2pWebrtcStar => "p2p-webrtc-star".to_owned(),
            ProtocolId::Libp2pWebrtcDirect => "p2p-webrtc-direct".to_owned(),
